...
{
    /// <summary>
    /// Scans for apparel designated R4_Clean, finds a nearby bench,
    /// and creates a clean job. Uses Crafting work type.
    /// </summary>
    public class WorkGiver_R4Clean : WorkGiver_Scanner
    {
        ...
        public override Job JobOnThing(Pawn pawn, Thing t, bool forced = false)
        {
            ...
            Job job = JobMaker.MakeJob(R4DefOf.RRRR_Clean, t, bench);
            job.count = 1;
            return job;
        }
        ...
        {
            // Cleaning is apparel-only, so route via apparel benches
